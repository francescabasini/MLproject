...
from metrics_and_useful_functions import top_3_categorical_accuracy, crop_image_train_resnet50, crop_image_valid_resnet50
...
# save model
model.save(os.path.join(work_dir, 'RN50_onlyTOP_differentcrops_11epoch.h5'))
model.save_weights(os.path.join(work_dir, 'RN50_onlyTOP_differentcrops_11epoch_WEIGHTS.h5'))

# save history in a pickle file
with open(os.path.join(work_dir, 'hist_RN50_onlyTOP_differentcrops_11epoch'), 'wb') as file_pi:
...
best_model = load_model(os.path.join(work_dir, 'RN50_onlyTOP_differentcrops_11epoch.h5'),
...
import pickle
with open(os.path.join(work_dir, 'hist_RN50_onlyTOP_differentcrops_11epoch'), 'rb') as file_pi:
